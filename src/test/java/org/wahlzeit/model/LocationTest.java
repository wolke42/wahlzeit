...
public class LocationTest {
	...
	public void littleValuesTest() {
		...
		Coordinate coord2 = new Coordinate(1.0, 3.0);
		Coordinate coord3 = new Coordinate(5.0, 6.1234);
		Coordinate coord4 = new Coordinate(15.321, 21.7);
		Coordinate coord5 = new Coordinate(76.54321, 89.000001);
	...
	public void bigValuesTest() {
		Coordinate coord1 = new Coordinate(1.0, 1.0);
		Coordinate coord2 = new Coordinate(90.0, 180.0);
		Coordinate coord3 = new Coordinate(-89.1234, 179.0);
		Coordinate coord4 = new Coordinate(80.0, -178.0);
		Coordinate coord5 = new Coordinate(-70.0001, -89.000001);
		Location loc1 = new Location(coord1);
		Location loc2 = new Location(coord2);
		Location loc3 = new Location(coord3);
		Location loc4 = new Location(coord4);
	...
	public void kommutativeTest() {
		Coordinate coord1 = new Coordinate(1.0, 1.0);
		Coordinate coord2 = new Coordinate(78.912, -167.89);
		Coordinate coord3 = new Coordinate(-55.555, 150.0);
		Location loc1 = new Location(coord1);
		Location loc2 = new Location(coord2);
		Location loc3 = new Location(coord3);
		double dist1To2 = loc1.getDistance(loc2);
	...
	public void specialCasesTest() {
		...
		Coordinate coord2 = new Coordinate(12.345, -100.0);
		Coordinate coord3 = new Coordinate(-45.2, 178.1);
		Location loc1 = new Location(coord1);
		Location loc2 = new Location(coord2);
		Location loc3 = new Location(coord3);
